...
public class EmployeeRepository {
    ...
    //*************************************
    public static void updateEmpEmail (String id, String name, String lastname, String email, String job) throws SQLException, ClassNotFoundException {
    ...
    //INSERT an employee
    //*************************************
    public static void insertEmp (String id, String name, String lastname, String email, String job) throws SQLException, ClassNotFoundException {
        //Declare a DELETE statement
        String updateStmt =
                "BEGIN\n" +
                        ...
                        "VALUES\n" +
                        "(" + id + ", '"+name+"', '"+lastname+"','"+email+"', SYSDATE, '"+job+"');\n" +
                        "END;";
